...
function getCurrentInstanceForFn(hook, target) {
    ...
    if ((process.env.NODE_ENV !== 'production') && !target) {
        warn$1("".concat(hook, " is called when there is no active component instance to be ") +
            "associated with. " +
...
function createSlotProxy(vm, slotName) {
    return (function () {
        ...
        if (!vm.$scopedSlots[slotName]) {
            if ((process.env.NODE_ENV !== 'production'))
                return warn$1("slots.".concat(slotName, "() got called outside of the \"render()\" scope"), vm);
            return;
        }
...
function createWatcher(vm, source, cb, options) {
    ...
    if (isRef(source)) {
        ...
        getter = function () {
            return source.map(function (s) {
                if (isRef(s)) {
                    ...
                    (process.env.NODE_ENV !== 'production') &&
                        warn$1("Invalid watch source: ".concat(JSON.stringify(s), ".\n          A watch source can only be a getter/effect function, a ref, a reactive object, or an array of these types."), vm);
                    return noopFn;
                }
            });
        };
        ...
        getter = noopFn;
        (process.env.NODE_ENV !== 'production') &&
            warn$1("Invalid watch source: ".concat(JSON.stringify(source), ".\n      A watch source can only be a getter/effect function, a ref, a reactive object, or an array of these types."), vm);
    }
    if (deep) {
...
function inject(key, defaultValue, treatDefaultAsFactory) {
    ...
    if (!key) {
        (process.env.NODE_ENV !== 'production') && warn$1("injection \"".concat(String(key), "\" not found."), vm);
        return defaultValue;
    }
    ...
    function createSetupContext(vm) {
        ...
        propsPlain.forEach(function (key) {
            ...
            proxy(ctx, key, {
                ...
                set: function () {
                    (process.env.NODE_ENV !== 'production') &&
                        warn$1("Cannot assign to '".concat(key, "' because it is a read-only property"), vm);
                },
            });
        });
